...
struct SensorVQFParams : VQFParams {
    SensorVQFParams()
        ...
        motionBiasEstEnabled = true;  // Enable bias estimation for stability
#endif
        ...
        // Set balanced cutoff filters
        accLpB[0] = 3.0f;           // Moderate accelerometer filtering
        magLpB[0] = 0.75f;          // Moderate magnetometer filtering
    }
};
#endif
